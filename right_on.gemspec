...
Gem::Specification.new do |s|
  ...
  ## as you like.
  s.summary     = "Set of extensions to core rails to give rights and roles."
  s.description = "This helps systems manage rights and roles on a controller/action basis."
  ...
  s.homepage = 'http://github.com/sealink/right_on'
